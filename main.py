...
class BBotConsola:
    def __init__(self):
        ...
        # 2. Estados de Navegación (4 opciones de nuevo)
        ...
        self.hambre = 50
        self.energia = 100
        self.estado_bot = "NORMAL" # NORMAL, RISA, SUEÑO, HAMBRE
        self.timer_emo = 0
    ...
    def mostrar_mensaje_carga(self):
        ...
        txt = pygame.font.SysFont("Arial", 25, True).render("BUSCANDO EN LA NUBE...", True, COLOR_NEON)
